...
figure();
plot(f,module_1_power_seperate./(module_1_power_seperate+module_2_power_seperate))
hold on;
plot(f,module_2_power_seperate./(module_1_power_seperate+module_2_power_seperate))
...
figure();
plot(f,module_1_power_series./(module_1_power_series+module_2_power_series))
hold on;
plot(f,module_2_power_series./(module_1_power_series+module_2_power_series))
legend('Receiver-1','Receiver-2','FontName','TimesNewRoman','FontSize',12, ...
    'Interpreter','Latex')
ylabel(Powe)
%%
...
figure();
plot(f,module_1_power_parallel./(module_1_power_parallel+module_2_power_parallel))
hold on;
plot(f,module_2_power_parallel./(module_1_power_parallel+module_2_power_parallel))
