...
plot(wRL/2/pi/1000,4./RL1k(1,:),'-','Color',[0.8 0 0],'LineWidth',2);
hold on;
plot(wRL/2/pi/1000,1-(4./RL1k(1,:)),'--','Color',[0 0 0.8],'LineWidth',2);
hold on;
plot(wRL/2/pi/1000,4./RL1k(2,:),'>','Color',[0.8 0 0]);
hold on;
plot(wRL/2/pi/1000,1-(4./RL1k(2,:)),'>','Color',[ 0 0 0.8]);
hold on;
plot(wRL/2/pi/1000,(4./RL1k(3,:)),'o','Color',[0.8 0 0]);
hold on;
plot(wRL/2/pi/1000,1-(4./RL1k(3,:)),'o','Color',[0 0 0.8]);
% Create ylabel
