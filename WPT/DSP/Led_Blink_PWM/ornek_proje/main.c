...
int main(void)
{
    ...
    EALLOW;
    ClkCfgRegs.PERCLKDIVSEL.bit.EPWMCLKDIV = 1; // EPWM Clock Divide Select: /2 of PLLSYSCLK
    // // hakan sarac a soralim !!!!
    EDIS;
...
void InitializeEpwm1Registers()
{
    ...
    EPwm1Regs.TBPRD = 65536;  /*period is set to be 10khz (for up down count)*/
    ...
    EPwm1Regs.CMPB.bit.CMPB = EPwm1Regs.TBPRD / 2;    // Set compare A value
