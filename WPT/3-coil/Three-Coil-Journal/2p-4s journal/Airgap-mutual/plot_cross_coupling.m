...
seconder1=[seconder1(1:end),seconder1(1)];
seconder2=[seconder2(1:end),seconder2(1)];
seconder3=[seconder3(1:end),seconder3(1)];
seconder4=[seconder4(1:end),seconder4(1)];
...
figure()
p3=plot(bended_angle(1:end),[bended_p1_total(18:end-1),bended_p1_total(1:17),...
     bended_p1_total(18)],'-pb','LineWidth',1.5);
p3.Color(4) = 0.5;
hold on;

p4=plot(bended_angle(1:end),  [bended_p1_total(27:end-1),bended_p1_total(1:26),...
    bended_p1_total(27) ],'-pg','LineWidth',1.5);
p4.Color(4) = 0.5;
hold on;
...
p2=plot(bended_angle(1:end),[bended_p1_total(9:end-1),bended_p1_total(1:8), ...
    bended_p1_total(9)],'-pr','LineWidth',1.5);
