clear all;
clc;
load('G:\My Drive\WPT-Testler\2020.12.03\1RxFault\data.mat')
...
plot(t_itx1*1e6,i_tx1*10,'DisplayName','I_{Tx1}','Color',[1 0 0],'LineWidth',2,'LineStyle','-');
...
plot(t_rx1*1e6,i_rx1,'DisplayName','I_{Rx1}','Color',[1 0 0],'LineWidth',2,'LineStyle','-');
