...
filename = 'Z:\Github\Studies\WPT\LTspice\2p4s_makale modelleri\Matlab_file\zin048';
delimiter = {'\t',','};
startRow = 2;
...
result = table;
result.freq = cell2mat(raw(:, 1));
result.gain = cell2mat(raw(:, 2));
result.phase = cell2mat(raw(:, 3));
