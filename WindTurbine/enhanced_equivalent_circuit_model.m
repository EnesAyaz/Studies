...
hold(axes1,'on');
plot(fs*20*w,abs(Te3/1000),'DisplayName','3-phase Equivalent circuit model','LineWidth',1,...
    'Color',[1 0 0]);
plot(fs*20*w,abs(Te6/1000),'DisplayName','6-phase Equivalent circuit model','LineWidth',1,...
    'Color',[0 1 0]);
% Create plot
plot(H_z,abs(Torque),'SeriesIndex',3,'DisplayName','3-phase rmxprt model',...
    'LineWidth',1,...
    'Color',[0 0 1]);
plot(speed,abs(Torquea),'SeriesIndex',3,'DisplayName','6-phase transient model',...
    'LineWidth',1,...
    'Color',[1 0 1]);
