...
%  A=SAIA_mag(i)*capA_phA(i);
%  B=SBIB_mag(i)*capA_phB(i);
%  C=SCIC_mag(i)*capA_phC(i);
 ...
 y= A*A +B*B+ C*C;
 x1=2*A*B*cos(SAIA_angle(i)-SBIB_angle(i));
 x2=2*B*C*cos(SCIC_angle(i)-SBIB_angle(i));
 x3=2*A*C*cos(SAIA_angle(i)-SCIC_angle(i));
