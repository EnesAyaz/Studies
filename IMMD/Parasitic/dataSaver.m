...
% capA= simout.ACapCurr.Data(1:end);
% capB=simout.BCapCurr.Data(1:end);
% capC=simout.CCapCurr.Data(1:end);
% save('CapacitorCurr_31.mat','time','capA','capB','capC');


% time= simout1.ACapVolt.Time(1:end);
% capA= simout1.ACapVolt.Data(1:end);
% capB=simout1.BCapVolt.Data(1:end);
% capC=simout1.CCapVolt.Data(1:end);
% save('CapacitorVolt_3.mat','time','capA','capB','capC');
...
save('InputVoltCurr_3.mat','time','InputCurr','InputVoltage');
